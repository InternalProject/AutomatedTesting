...
public class AddStreamPage extends Components{
	...
	public void allTextArePresent(){
		...
		checkElementText("AddStream department title", "AddEditStream department title", departmentTitle);		
		checkElementText("AddStream department name title", "AddEditStream department name title", departmentNameField);		
		...
		Reporter.log("<br><br><b>"+"All text on Stream Page is present"+"</b><br>");
	}
	...
	public void checkDepartment(Departments currentDepartment){
