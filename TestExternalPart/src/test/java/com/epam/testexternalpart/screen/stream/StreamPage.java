...
public class StreamPage extends Components {
	...
	public void allElementArePresent(){
		TestReporter.writeToReportTitle("Checking the presence of Stream's elements");
	
		isElementExist( "Stream Create Button", title, true);
		
		isElementExist( "Stream Create Button", assignTestButton, true);
		isElementExist( "Stream Create Button", bunButton, true);
		isElementExist( "Stream Create Button", deleteButton, true);
		isElementExist( "Stream Create Button", bunButton, true);
		isElementExist( "Stream Create Button", allCandidateTab, true);
		isElementExist( "Stream Create Button", notTestedCandidate, true);
		isElementExist( "Stream Create Button", assignedToTestTab, true);
		isElementExist( "Stream Create Button", testCompleteTab, true);
		
		isElementExist( "Stream Create Button", bannedTab, true);
		isElementExist( "Stream Create Button", searchTab, true);
		isElementExist( "Stream Create Button", addCandidateTab, true);
		isElementExist( "Stream Create Button", chooseCandidateButton, true);
		isElementExist( "Stream Create Button", importCandidateButton, true);
