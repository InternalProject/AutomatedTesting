...
public class CreateProfilePage extends Components{
	...
	private static final String PROFILE_LEGEND = "//fieldset//legend";
	...
	public void checkTextPresent(String text){
		...
		checkElementText("New candidate", "Profile Page legend", legend);
